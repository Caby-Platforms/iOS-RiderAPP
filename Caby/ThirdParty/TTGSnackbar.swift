...
private extension TTGSnackbar {
    ...
    func configure() {
        ...
        // Notification
//        NotificationCenter.default.addObserver(self, selector: #selector(onScreenRotateNotification), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)

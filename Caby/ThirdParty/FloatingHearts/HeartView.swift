...
struct HeartTheme {
    ...
    static func randomTheme() -> HeartTheme {
        ...
        //FIX ME:- To Change Color Pl Check Here
        return HeartTheme(fillColor: UIColor.ColorLightBlueForStar, strokeColor: theme.1)
    }
}
...
public class HeartView: UIView {
    ...
    private func travelPath(inView view: UIView) -> UIBezierPath? {
        ...
        let endPointY = CGFloat(84)//viewHeight / 8.0 + randomNumber(cap: viewHeight / 4.0)
    ...
    private func addPathAnimation(inView view: UIView) {
        ...
        let durationAdjustment = 6 * TimeInterval(heartTravelPath.bounds.height / view.bounds.height)
